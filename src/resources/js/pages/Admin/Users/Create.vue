...
<template>
    <layout-default>
        ...
        <template #header>
            ...
            <h1 class="mt-1 text-2xl font-black tracking-tight text-[#17201c]">Create User</h1>
        </template>

        <section class="rounded-[28px] border border-[#ded5c5] bg-[#fffbf3] p-5 shadow-sm sm:p-8">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm font-bold uppercase tracking-[0.2em] text-[#bd7b2f]">New account</p>
                    <h2 class="mt-2 text-3xl font-black tracking-tight text-[#17201c]">Add a user</h2>
                </div>
            ...
            <form class="mt-8 grid gap-5 lg:max-w-2xl" @submit.prevent="submit">
                ...
                <div class="grid gap-5 sm:grid-cols-2">
                    <div>
                        <label for="password" class="mb-2 block text-sm font-bold text-[#27332f]">Password</label>
                        <input
                            id="password"
