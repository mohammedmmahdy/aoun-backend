...
* @see app/Http/Controllers/Admin/ProviderController.php:13
* @route '/providers'
*/
...
* @see app/Http/Controllers/Admin/ProviderController.php:30
...
* @see app/Http/Controllers/Admin/ProviderController.php:36
* @route '/providers'
*/
...
* @see app/Http/Controllers/Admin/ProviderController.php:48
...
* @see app/Http/Controllers/Admin/ProviderController.php:60
...
* @see app/Http/Controllers/Admin/ProviderController.php:71
* @route '/providers/{provider}'
*/
...
* @see app/Http/Controllers/Admin/ProviderController.php:80
* @route '/providers/{provider}'
*/
...
const ProviderController = { index, create, store, show, edit, update, destroy }
