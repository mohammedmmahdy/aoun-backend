        ...
        >
            ...
            >
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    >
                        ...
                        >
                            <path
                                d="m21 21-4.3-4.3 M10.8 18a7.2 7.2 0 1 0 0-14.4 7.2 7.2 0 0 0 0 14.4Z"
                                stroke="currentColor"
                                stroke-width="1.8"
                                stroke-linecap="round"
                            />
                    ...
                    >
                        ...
                        <div class="flex items-center gap-2 md:justify-end">
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M2.5 12.9a1.8 1.8 0 0 1 0-1.8C3.6 9.2 7 5 12 5s8.4 4.2 9.5 6.1a1.8 1.8 0 0 1 0 1.8C20.4 14.8 17 19 12 19s-8.4-4.2-9.5-6.1Z"
                                        stroke="currentColor"
                                        stroke-width="1.8"
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M4 20h4l10.5-10.5a2.1 2.1 0 0 0-3-3L5 17v3Z M14 8l2 2"
                                        stroke="currentColor"
                                        stroke-width="1.8"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                            ...
                            >
                                ...
                                >
                                    <path
                                        d="M5 7h14 M10 11v6 M14 11v6 M8 7l1-3h6l1 3 M7 7l1 13h8l1-13"
                                        stroke="currentColor"
                                        stroke-width="1.8"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
            ...
            >
                <Link
                    ...
                    :class="[
                        link.active
                            ? 'border-[#12352d] bg-[#12352d] text-[#fff8e8]'
                            : 'border-[#d6ccbd] bg-white text-[#526158] hover:border-[#1d6a58] hover:text-[#1d6a58]',
