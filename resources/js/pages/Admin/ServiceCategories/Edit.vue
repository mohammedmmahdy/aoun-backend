...
const form = useForm({
    ...
    email: props.serviceCategory.email,
    password: "",
    password_confirmation: "",
});

const submit = () => {
    form.put(ServiceCategoryController.update(props.serviceCategory.id), {
        preserveScroll: true,
...
<template>
    <layout-default>
        <Head :title="`Edit ${serviceCategory.name}`" />
        ...
        >
            ...
            >
                ...
                <Link
                    ...
                    >Back to service categories</Link
                >
            </div>
