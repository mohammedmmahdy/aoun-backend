...
const destroy = () => {
    ...
    deleteForm.delete(ServiceController.destroy(props.service.id), {
        preserveScroll: true,
    });
};
</script>
        ...
        <section class="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
            ...
            >
                ...
                >
                    ...
                    <div class="grid gap-1 px-5 py-4 sm:grid-cols-[180px_1fr]">
                        <p class="text-sm font-black text-[#66756d]">Image</p>
                        <p class="text-sm font-semibold text-[#27332f]">
                            <img :src="service.image" :alt="service.name" class="h-11 w-11 rounded-2xl object-cover" />
                        </p>
                    </div>
                    <div class="grid gap-1 px-5 py-4 sm:grid-cols-[180px_1fr]">
                        <p class="text-sm font-black text-[#66756d]">Category</p>
                        <p class="text-sm font-semibold text-[#27332f]">
                            {{ service.category }}
                        </p>
                    </div>
                    <div class="grid gap-1 px-5 py-4 sm:grid-cols-[180px_1fr]">
                        <p class="text-sm font-black text-[#66756d]">Provider</p>
                        <p class="text-sm font-semibold text-[#27332f]">
                            {{ service.provider }}
                        </p>
                    </div>
                    <div class="grid gap-1 px-5 py-4 sm:grid-cols-[180px_1fr]">
                        <p class="text-sm font-black text-[#66756d]">Duration</p>
                        <p class="text-sm font-semibold text-[#27332f]">
                            {{ service.duration }}
                        </p>
                    </div>
                    <div class="grid gap-1 px-5 py-4 sm:grid-cols-[180px_1fr]">
                        <p class="text-sm font-black text-[#66756d]">Status</p>
